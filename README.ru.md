...
1. **Разворачивание и начальная настройка:**
   - После разворачивания контракта создатель пополняет его жетонами и устанавливает блокировку (**лок**) на **полгода**, **квартал** или **10 минут** (для начального тестирования контракта).
   - Создатель может продлить **лок** на дополнительный период: **полгода**, **квартал** или **10 минут**.
